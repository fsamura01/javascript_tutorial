...
console.log("freq.toString exists:", typeof freq.toString);
console.log("freq.hasOwnProperty exists:", typeof freq.hasOwnProperty);
console.log("freq.valueOf exists:", typeof freq.valueOf);

// We can even call these inherited methods
console.log("Calling freq.toString():", freq.toString()); // "[object Object]"
console.log(
  "Calling freq.hasOwnProperty('toString'):",
  freq.hasOwnProperty("toString")
...
console.log(
  "freqMap.toString exists as inherited method:",
  typeof freqMap.toString
); // "function" (but doesn't interfere)
...
console.log(
  "freqMap.get('toString') returns our data:",
  freqMap.get("toString")
); // 1
